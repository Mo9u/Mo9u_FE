...
function Test() {
  ...
  const questionList = [
    ...
    {q:['내일 먹을 버섯 전골에 들어갈','채소를 사야할 때 나는?'],
     a:[{type:"I",text:'‘나가기 귀찮아...’ 인터넷으로 주문한다'},
  ...
  const [mbtiList, setMbtiList] = useState([
    {name:'I',count:0},{name:'E',count:0},{name:'T',count:0},{name:'F',count:0},
  ...
  const [resultContent,setResultContent] = useState("자신감과 건강한 마음을 지닌 당신에게\n몸 건강도 챙길 수 있는 “필리”를 추천합니다.");   
      ...
      {page === 0 ? (
        ...
        <div className='startPageLayout'>
          ...
          <div className='testLayout'>
            ...
            <div onClick={() => setPage(1)} className='startButton'>구독 유형 검사하기</div>
          </div>
